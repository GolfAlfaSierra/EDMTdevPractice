package com.sogbatyan.artyom.androidweatherapp;
...
public class CityFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        new ListCities().execute(); //asynctask to load list of cities

        return itemView;
    }

    private class ListCities extends SimpleAsyncTask<List<String>> {
                ...
                .subscribe(new Consumer<WeatherResult>() {
                    ...
                    public void accept(WeatherResult weatherResult) {
                        ...
                        txt_wind.setText(new StringBuilder
                                ("Speed: ").append(weatherResult.getWind().getSpeed())
