package com.sogbatyan.artyom.androidweatherapp.Adapter;
...
import com.sogbatyan.artyom.androidweatherapp.R;
...
public class WeatherForecastAdapter extends RecyclerView.Adapter<WeatherForecastAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.txt_description.setText(new StringBuilder(weatherForecastResult.list
